...
import ort.clases.parcial_22a_tp3.domain.models.Offer
    ...
    private fun getOffers(): List<Offer> {
        ...
        return listOf(
            ...
            Offer(
                ...
                cardType = "VISA",
                description = "Use your VISA credit or debit card with any transaction and get 25% discount instantly!",
                imageRes = R.drawable.tarjeta_visa,
                isLimitedOffer = true
            )
            // Aca se agregan mas ofertas
        )
    }
}